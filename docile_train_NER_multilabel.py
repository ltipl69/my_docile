...
if __name__ == "__main__":
    ...
    if args.use_lilt:
        config = LiltConfig.from_pretrained("nielsr/lilt-xlm-roberta-base")
    else:
    ...
    if args.use_lilt:
        ...
        model = MyLiltForTokenClassification.from_pretrained(
            "nielsr/lilt-xlm-roberta-base", config=config
        )
    ...
    log_path=os.path.join(args.output_dir, 'runs')
    print(f"INFO: tensorboard stored in {log_path}")
